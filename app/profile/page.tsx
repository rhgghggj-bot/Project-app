...
export default function Profile() {
  ...
  const couleurProfil = profil?.couleur || "#2B7FFF"
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div style={{padding:'0 18px'}}>
        ...
        {profil?.bio && <div style={{fontSize:'13px',color:'#666',marginTop:'6px',lineHeight:'1.5'}}>{profil.bio}</div>}
              ...
              <a key={projet.id} href={`/projet/${projet.id}`}>
                <div style={{background:'#fff',border:'0.5px solid #E8F1FF',borderRadius:'16px',overflow:'hidden',marginBottom:'12px',cursor:'pointer'}}>
                  ...
                  <div style={{padding:'12px 14px'}}>
                    ...
                    <div style={{fontSize:'14px',fontWeight:'500',color:'#1a1a2e',marginTop:'8px',marginBottom:'4px'}}>{projet.titre}</div>
                    ...
                    <div style={{display:'flex',gap:'12px',paddingTop:'10px',borderTop:'0.5px solid #E8F1FF'}}>
                      <span style={{fontSize:'12px',color:'#aaa'}}>❤️ 0</span>
                      <span style={{fontSize:'12px',color:couleurProfil}}>💬 Voir les conseils →</span>
                    </div>
                  </div>
                </div>
              </a>
        ...
        {onglet === "settings" && (
          <div>
            <div style={{background:'#fff',border:'0.5px solid #E8F1FF',borderRadius:'16px',overflow:'hidden',marginBottom:'12px'}}>
              <div style={{padding:'14px 16px',borderBottom:'0.5px solid #E8F1FF'}}>
                ...
                <button onClick={sauvegarderProfil}
                  style={{width:'100%',background:couleur,color:'#fff',fontSize:'13px',fontWeight:'500',padding:'10px',borderRadius:'10px',border:'none',cursor:'pointer'}}>
                  Sauvegarder
                </button>
            ...
            <div style={{background:'#fff',border:'0.5px solid #E8F1FF',borderRadius:'16px',overflow:'hidden',marginBottom:'12px'}}>
              <div style={{display:'flex',alignItems:'center',gap:'12px',padding:'14px 16px',borderBottom:'0.5px solid #E8F1FF'}}>
                <div style={{width:'36px',height:'36px',background:'#E1F5EE',borderRadius:'10px',display:'flex',alignItems:'center',justifyContent:'center',fontSize:'16px'}}>❓</div>
                <div style={{flex:1}}><div style={{fontSize:'14px',fontWeight:'500',color:'#1a1a2e'}}>Aide & support</div><div style={{fontSize:'12px',color:'#aaa'}}>Nous contacter</div></div>
                <span style={{color:'#aaa'}}>›</span>
              </div>
              <div style={{display:'flex',alignItems:'center',gap:'12px',padding:'14px 16px'}}>
                <div style={{width:'36px',height:'36px',background:'#F5F5F5',borderRadius:'10px',display:'flex',alignItems:'center',justifyContent:'center',fontSize:'16px'}}>📋</div>
                <div style={{flex:1}}><div style={{fontSize:'14px',fontWeight:'500',color:'#1a1a2e'}}>Conditions d'utilisation</div><div style={{fontSize:'12px',color:'#aaa'}}>CGU & confidentialité</div></div>
                <span style={{color:'#aaa'}}>›</span>
              </div>
            </div>
