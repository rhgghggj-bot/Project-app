      ...
      <div className="px-5">
        <div className="flex items-end justify-between -mt-8 mb-4">
          ...
          <a href="/nouveau-projet">
            <button className="text-sm bg-blue-500 text-white px-4 py-2 rounded-full font-medium">+ Nouveau projet</button>
          </a>
        </div>
        ...
        <div className="flex gap-3 mb-6">
          ...
          <div className="flex-1 bg-blue-50 rounded-xl p-3 text-center border border-blue-100">
            <p className="text-lg font-medium text-blue-500">0</p>
        ...
        {projets.map((projet: any) => (
          <a key={projet.id} href={`/projet/${projet.id}`}>
            <div className="bg-white border border-blue-100 rounded-2xl overflow-hidden mb-4 cursor-pointer">
